...
import useUpdateReview from "../../hooks/reviews/useUpdateReviews";
...
const UpdateReview = () => {
  ...
  useEffect(() => {
    if (state.review) {
      const { image, link, name, text } = state.review;
      form.setFieldsValue({
        name_en: name.en,
        name_ar: name.ar,
        link: link,
        ...
        const initialFileList = [
          {
            ...
            status: "done",
            url: image, // assuming this is the image URL
          } as UploadFile,
        ];
      ...
      <div className="mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">
            Update review with multilingual support
          </p>
        </div>
        ...
        <div className="relative bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-200/50 overflow-hidden">
          ...
          <div className="p-8">
            ...
            >
              ...
              <Form.Item
                label={<span className="text-slate-700 font-medium">Link</span>}
                name="link"
                rules={[
                  {
                    required: true,
