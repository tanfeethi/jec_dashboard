...
const AllReviews = () => {
  const { data: reviewsData, isLoading } = useFetchReviews();
  const { mutate: deleteReviewsMutate, isPending } = useDeleteReviews();
    ...
    },
    {
      ...
      render: (_: any, record: any) => (
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={() =>
              navigate(`/reviews/edit/${record.id}`, {
                state: { review: record },
              })
            }
          ...
          {/* Delete Button */}
          <button
            onClick={() => deleteReviewsMutate(record.id)}
        ...
        <div className="relative px-8 py-6 bg-gradient-to-r from-slate-50 via-white to-slate-50 border-b border-slate-200/80">
          ...
          <div className="relative">
            ...
            <p className="text-slate-600 text-sm font-medium">
              Manage and organize your reviews listings.
            </p>
          </div>
        </div>
