...
import useUpdateTestimonial from "../../hooks/testimonials/useUpdateTestimonials";
...
const UpdateTestimonials = () => {
  ...
  useEffect(() => {
    if (state?.testimonial) {
      const { name, position, text, socialType, socialUrl, image } =
        state.testimonial;
      form.setFieldsValue({
        name_en: name.en,
        name_ar: name.ar,
  ...
  const {
    mutate: UpdateTestimonialMutate,
    isError,
    error,
    isPending,
  ...
  const onFinish = (values: any) => {
    ...
    UpdateTestimonialMutate(payload);
  };
      ...
      <div className="mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">
            Update testimonial with multilingual support
          </p>
        </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Please enter social url",
                    },
                  ]}
                  className="!mb-0"
                >
