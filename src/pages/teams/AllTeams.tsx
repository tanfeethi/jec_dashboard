...
const AllTeams = () => {
  ...
  const { data: testimonialsData, isLoading } = useFetchTeams();
  const { mutate: deleteTeamMutate, isPending } = useDeleteTeam();
    ...
    },
    {
      ...
      render: (_: any, record: any) => (
        <div className="flex items-center gap-3">
          ...
          {/* Delete Button */}
          <button
            onClick={() => deleteTeamMutate(record.id)}
        ...
        <div className="relative px-8 py-6 bg-gradient-to-r from-slate-50 via-white to-slate-50 border-b border-slate-200/80">
          ...
          <div className="relative">
            ...
            <p className="text-slate-600 text-sm font-medium">
              Manage and organize your team listings.
            </p>
          </div>
        </div>
