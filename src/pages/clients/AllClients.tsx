...
import { useFetchClients } from "../../hooks/clients/allClients";
import { useDeleteClient } from "../../hooks/clients/deleteClient";

const AllClients = () => {
    const [page, setPage] = useState(1);
    const { data: clientsData, isLoading } = useFetchClients();
    const { mutate: deleteClientMutate, isPending } = useDeleteClient();
        ...
        },
        {
            ...
            render: (_: any, record: any) => (
                <div className="flex items-center gap-3">
                    ...
                    {/* Delete Button */}
                    <button
                        onClick={() => deleteClientMutate({ id: record.id })}
                ...
                <div className="relative px-8 py-6 bg-gradient-to-r from-slate-50 via-white to-slate-50 border-b border-slate-200/80">
                    ...
                    <div className="relative">
                        ...
                        <p className="text-slate-600 text-sm font-medium">
                            Manage and organize your client listings.
                        </p>
                    </div>
                </div>
