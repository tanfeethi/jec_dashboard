...
import useUpdateStaticPage from "../../hooks/staticPages/useUpdateStaticPages";
...
const UpdateStaticPages = () => {
  ...
  const onFinish = (values: any) => {
    ...
    UpdateStaticPageMutate(payload);
  };
  ...
  useEffect(() => {
    if (state?.static) {
      const { name, title, text, image, status } = state.static;
      ...
      <div className="mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">
            Update static page with multilingual support
          </p>
        </div>
